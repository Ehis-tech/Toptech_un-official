...
function WhatWeOffer() {
  const servicesData = [
    ...
    },
    {
      ...
      description:
        'We offer HAVAC or AC installations for data center rooms...',
      icon: assets.hvac_image,
    },
    {
      title: 'Low Voltage Panels',
      description:
        'We help you build a strong and presentable low voltage pannel.',
  ...
  return (
    ...
    >
      ...
      <Title
        text1={'What We'}
        text2={'Offer'}
        text3={'The services below can be rendered by us,just make a call'}
      />
